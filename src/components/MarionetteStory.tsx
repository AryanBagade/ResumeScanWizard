...
interface MarionetteStoryProps {
  candidateName?: string;
}

export default function MarionetteStory({ candidateName }: MarionetteStoryProps) {
    ...
    const loadScripts = async () => {
      ...
      await new Promise((resolve) => {
        ...
        const checkLoaded = () => {
          loaded++;
          if (loaded === 3) {
            setTimeout(resolve, 500); // Small delay to ensure all is ready
          }
        };
